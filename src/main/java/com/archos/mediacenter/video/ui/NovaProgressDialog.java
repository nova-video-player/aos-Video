...
package com.archos.mediacenter.video.ui;
 ...
 *
 * <code>NovaProgressDialog</code> is a modal dialog, which prevents the
...
public class NovaProgressDialog extends AlertDialog {
    ...
    /**
     * Creates a NovaProgressDialog with a horizontal progress bar.
     */
     ...
     */
    public NovaProgressDialog(Context context, int theme) {
        super(context, theme);
        mContext = context;
        initFormats();
    }
    ...
    /**
     * Change the indeterminate mode for this NovaProgressDialog. In indeterminate
     * mode, the progress is ignored and the dialog shows an infinite
     * animation instead.
     *
     * <p><strong>Note:</strong> A NovaProgressDialog with style {@link #STYLE_SPINNER}
    ...
    /**
     * Whether this NovaProgressDialog is in indeterminate mode.
     *
    ...
    /**
     * Sets the style of this NovaProgressDialog, either {@link #STYLE_SPINNER} or
     ...
     *
     * @param style the style of this NovaProgressDialog, either {@link #STYLE_SPINNER} or
