...
public class FilmsByGenreLoader extends FilmsByLoader {

    private static final String DEFAULT_SORT = COLUMN_SUBSET_NAME+" COLLATE NOCASE";

    public FilmsByGenreLoader(Context context) {
        super(context);
        mSortOrder = DEFAULT_SORT;
        setSelection(getSelection(context));
    }
    public FilmsByGenreLoader(Context context, String sortOrder) {
        super(context);
