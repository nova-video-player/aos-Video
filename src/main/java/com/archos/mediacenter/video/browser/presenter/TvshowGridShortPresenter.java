 ...
 */
public class TvshowGridShortPresenter extends TvshowGridPresenter{
    public TvshowGridShortPresenter(Context context, ExtendedClickListener listener) {
        super(context, AdapterDefaultValuesGridShort.INSTANCE, listener);
    }
}
