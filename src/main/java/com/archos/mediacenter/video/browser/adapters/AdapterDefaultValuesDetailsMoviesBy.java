...
public enum AdapterDefaultValuesDetailsMoviesBy implements AdapterDefaultValues {
    ...
    public int getLayoutId() {
        return R.layout.browser_item_details_movies_by;
    }
    ...
    public int getLayoutId(int itemType) {
        ...
        switch (itemType) {
            ...
            default:
                layoutId = R.layout.browser_item_details_movies_by;
                break;
        }
