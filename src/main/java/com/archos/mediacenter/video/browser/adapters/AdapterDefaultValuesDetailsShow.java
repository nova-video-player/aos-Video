...
public enum AdapterDefaultValuesDetailsShow implements AdapterDefaultValues {
    ...
    public int getLayoutId() {
        return R.layout.browser_item_details_series;
    }
    ...
    public int getLayoutId(int itemType) {
        ...
        switch (itemType) {
            ...
            default:
                layoutId = R.layout.browser_item_details_series;
                break;
        }
