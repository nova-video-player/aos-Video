...
public enum AdapterDefaultValuesListSeason implements AdapterDefaultValues {
    ...
    public int getLayoutId() {
        return R.layout.browser_item_list_season;
    }
    ...
    public int getLayoutId(int itemType) {
        ...
        switch (itemType) {
            ...
            default:
                layoutId = R.layout.browser_item_list_season;
                break;
        }
