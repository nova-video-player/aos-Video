...
public abstract class Browser extends Fragment implements AbsListView.OnScrollListener,
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        if (mBrowserAdapter != null && !mBrowserAdapter.isEmpty()) {
            ...
            MenuItem viewModeMenuItem = menu.add(MENU_VIEW_MODE_GROUP, MENU_VIEW_MODE, Menu.NONE, applyCustomFont(R.string.view_mode));
        ...
        if(shouldEnableMultiSelection())
            menu.add(0, R.string.multiple_selection, 0, applyCustomFont(R.string.multiple_selection));
    }
