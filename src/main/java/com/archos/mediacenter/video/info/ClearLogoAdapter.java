...
class ClearLogoAdapter extends RecyclerView.Adapter<ClearLogoAdapter.ViewHolder> {
    private List<ScraperImage> mList = Collections.emptyList();
    private final LayoutInflater mInflater;
    private final ImageViewSetter mSetter;
    private final VideoInfoClearLogoChooserFragment.ScraperImageThumbProcessor mLoader;
    ...
    public ClearLogoAdapter(Context context, OnItemClickListener listener) {
        mInflater = LayoutInflater.from(context);
        mSetter = new ImageViewSetter(context, null);
        mLoader = new VideoInfoClearLogoChooserFragment.ScraperImageThumbProcessor(context);
        mListener = listener;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.video_info_clearlogo_chooser_list_item, parent, false);
