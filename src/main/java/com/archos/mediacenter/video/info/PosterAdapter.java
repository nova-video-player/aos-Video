...
class PosterAdapter extends RecyclerView.Adapter<PosterAdapter.ViewHolder> {
    ...
    private final VideoInfoPosterChooserFragment.ScraperImageProcessor mLoader;
    ...
    public PosterAdapter(Context context, OnItemClickListener listener) {
        mInflater = LayoutInflater.from(context);
        mSetter = new ImageViewSetter(context, null);
        mLoader = new VideoInfoPosterChooserFragment.ScraperImageProcessor(context);
        mListener = listener;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.video_info_poster_chooser_list_item, parent, false);
