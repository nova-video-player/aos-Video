...
public class VideoCastControllerFragment extends Fragment implements
        OnVideoCastControllerListener, MediaAuthListener, ArchosVideoCastManager.ArchosCastManagerListener {

    private static final String EXTRAS = "extras";
    private static final String TAG = LogUtils.makeLogTag(VideoCastControllerFragment.class);
    private MediaInfo mSelectedMedia;
    private ArchosVideoCastManager mCastManager;
    ...
    public void onAttach(Activity activity) {
        ...
        mCastManager = ArchosVideoCastManager.getInstance();
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        /* <--archos changes> */
        boolean explicitStartActivity = VideoCastManager.getInstance().getPreferenceAccessor()
                .getBooleanFromPreference(VideoCastManager.PREFS_KEY_START_ACTIVITY, false);
        if (explicitStartActivity) {
            mIsFresh = true;
        }
        VideoCastManager.getInstance().getPreferenceAccessor().saveBooleanToPreference(
                VideoCastManager.PREFS_KEY_START_ACTIVITY, false);
        mCastController.setNextPreviousVisibilityPolicy(
                VideoCastManager.getInstance().getCastConfiguration().getNextPrevVisibilityPolicy());
    ...
    private class MyCastConsumer extends VideoCastConsumerImpl {
        ...
        public void onRemoteMediaPlayerMetadataUpdated() {
            /* <--archos changes> */
            mSelectedMedia = ArchosVideoCastManager.getInstance().getMediaInfo();
    ...
    public void onPause() {
        ...
        mCastManager.removeArchosCastManagerListener(this);
