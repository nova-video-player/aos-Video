...
public class SummaryListPreference extends ListPreference {
    private CharSequence[] mSummaryEntries = null;
    ...
    public void setSummaryEntries(CharSequence[] summaryEntries) {
        mSummaryEntries = summaryEntries;
    }
    
    public CharSequence[] getSummaryEntries() {
        return mSummaryEntries;
    }
}
