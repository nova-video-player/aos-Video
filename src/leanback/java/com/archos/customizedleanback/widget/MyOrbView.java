 ...
 */
public class MyOrbView extends FrameLayout implements View.OnClickListener {
    ...
    public MyOrbView(Context context) {
        this(context, null);
    }

    public MyOrbView(Context context, AttributeSet attrs) {
